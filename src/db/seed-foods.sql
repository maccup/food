...
INSERT INTO food_aliases (alias, food_id, ignored) VALUES
  ...
  ('kukurydza', 17, 0), ('kukurydza konserwowa', 17, 0), ('bakłażan', 18, 0), ('brokuły', 19, 0),
...
INSERT INTO restrictions (id, food_id, group_id, level, reason, source, date_from, date_to, status, max_amount) VALUES
  ...
  -- na czas leczenia metanu, do konca fazy low FODMAP (14.09)
  (9,  94,  NULL, 'forbidden', 'Fruktany', 'Dieta_obecna_ranking.md ranking C', '2026-08-03', '2026-09-14', 'active', NULL),
  (10, 96,  NULL, 'forbidden', 'Mannitol', 'Dieta_obecna_ranking.md ranking C', '2026-08-03', '2026-09-14', 'active', NULL),
  (11, 89,  NULL, 'forbidden', 'Fruktoza plus sorbitol, jedno z najsilniejszych źródeł objawów', 'Dieta_obecna_ranking.md ranking C', '2026-08-03', '2026-09-14', 'active', NULL),
  (12, 90,  NULL, 'forbidden', 'Fruktoza', 'Dieta_obecna_ranking.md ranking C', '2026-08-03', '2026-09-14', 'active', NULL),
  (13, 97,  NULL, 'forbidden', 'GOS', 'Dieta_obecna_ranking.md ranking C', '2026-08-03', '2026-09-14', 'active', NULL),
  (14, 98,  NULL, 'forbidden', 'GOS, jeden z najsilniejszych fermentujacych składników', 'Dieta_obecna_ranking.md ranking B', '2026-08-03', '2026-09-14', 'active', NULL),
  (15, 99,  NULL, 'forbidden', 'GOS', 'Dieta_obecna_ranking.md', '2026-08-03', '2026-09-14', 'active', NULL),
  (16, 100, NULL, 'limit',     'Mannitol powyżej pół łodygi', 'Dieta_obecna_ranking.md ranking B', '2026-08-03', '2026-09-14', 'active', 'mala ilosc, tylko do gotowania'),
  (17, 70,  NULL, 'forbidden', 'Wysokofermentujące', 'Dieta_obecna_ranking.md ranking B', '2026-08-03', '2026-09-14', 'active', NULL),
  (18, 71,  NULL, 'forbidden', 'Wysokofermentujące', 'Dieta_obecna_ranking.md ranking B', '2026-08-03', '2026-09-14', 'active', NULL),
  -- fermentowane: decyzja z 05.08, wracają pojedynczo przy rozszerzaniu
  (19, NULL, 14,  'forbidden', 'Laktoza i fermentujący substrat są paliwem dla przerostu, żywe kultury i tak giną od neomycyny, a produkty fermentowane to bogate źródło histaminy', 'Sidor-Baginska 2026-08-03, dopytanie 05.08', '2026-08-03', '2026-09-14', 'active', NULL),
  (20, 102, NULL, 'forbidden', 'Fermentujący substrat w płynie, czyli duza dawka naraz, plus ładunek histaminy. Najsilniejsza pozycja na liście', 'Dieta_obecna_ranking.md ranking C', '2026-08-03', '2026-09-14', 'active', NULL),
  (21, 59,  NULL, 'forbidden', 'Zyto to fruktany', 'Dieta_obecna_ranking.md ranking C', '2026-08-03', '2026-09-14', 'active', NULL),
  -- limity ilościowe
  ...
  (30, 75,  NULL, 'limit',     'Bardzo dużo błonnika na jedną porcję. Własna obserwacja: więcej błonnika to twardszy stolec', 'Analiza 2026-08-09', '2026-08-03', '2026-09-14', 'active', 'nie więcej niż raz dziennie'),
  (31, NULL, 20,  'limit',     'Surowe. Nie chodzi o sam produkt, tylko o formę w tym okresie', 'food_list.md, uwaga z 02.08', '2026-08-03', '2026-09-14', 'active', 'małe ilości'),
