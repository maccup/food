...
-- ---------------------------------------------------------------------------
-- CELE MAKRO
-- Te same w każdej fazie. Tłuszcz to zalecenie Piotrowskiego, błonnik i białko
-- wynikają z analizy z 09.08: elastaza 151, własna obserwacja o błonniku
...
INSERT INTO targets (id, phase_id, metric, min_value, max_value, source) VALUES
  ...
  (2,  1, 'protein_g',  130,  160, 'Piotrowski 2026-05-21: mniej białka. Gastrolog 2026-05-15: metionina a homocysteina'),
  (3,  1, 'fat_g',       80,  100, 'Piotrowski 2026-05-21. Elastaza trzustkowa 151 µg/g'),
